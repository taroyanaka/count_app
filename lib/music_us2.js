const music_us2_data = [
  [
      ...
      ["Doin' What Comes Natur'lly", "Dinah Shore with the Spade Cooley Orchestra"],
      ["Laughing on the Outside (Crying on the Inside)", "Dinah Shore"],
      ["Five Minutes More", "Tex Beneke with the Glenn Miller Orchestra"],
      ["Laughing on the Outside (Crying on the Inside)", "Andy Russell"],
      ["Hey! Ba-Ba-Re-Bop", "Tex Beneke with the Glenn Miller Orchestra"],
      ["They Say It's Wonderful", "Perry Como"],
      ["To Each His Own", "Tony Martin"],
      ["You Won't Be Satisfied (Until You Break My Heart)", "Les Brown"],
      ...
      ["Rumors Are Flying", "The Andrews Sisters and Les Paul Trio"],
  ...
  [
      ...
      ["Near You", "Larry Green Orchestra"],
      ...
      ["I Wonder Who's Kissing Her Now", "Ted Weems and Perry Como"],
      ["Near You", "The Andrews Sisters"],
      ["The Old Lamp-Lighter", "Sammy Kaye"],
      ["When You Were Sweet Sixteen", "Perry Como"],
      ["How Soon", "Jack Owens and Eddie Ballantine"],
      ...
      ["Civilization", "Danny Kaye and The Andrews Sisters with Vic Schoen"],
      ["The Old Lamp-Lighter", "Kay Kyser"],
      ["Open the Door, Richard!", "Count Basie"],
      ["Peg o' My Heart", "Art Lund"],
      ["You Do", "Margaret Whiting with Frank De Vol"],
      ...
      ["The Whiffenpoof Song", "Bing Crosby with Fred Waring"],
      ["Open the Door, Richard!", "Dusty Fletcher"],
      ["(I Love You) For Sentimental Reasons", "Eddy Howard"],
      ["Golden Earrings", "Peggy Lee with Dave Barbour"],
      ["Ole Buttermilk Sky", "Kay Kyser" ]
  ],
  [
      ["Twelfth Street Rag", "Pee Wee Hunt"],
      ["Mañana (Is Soon Enough for Me)", "Peggy Lee with Dave Barbour"],
      ["Now Is the Hour", "Bing Crosby with Ken Darby"],
      ...
      ["You Call Everybody Darlin'", "Al Trace with Bob Vincent"],
      ["My Happiness", "The Pied Pipers"],
      ["I'm Looking Over a Four Leaf Clover", "Art Mooney"],
      ["It's Magic", "Doris Day"],
      ["Maybe You'll Be There", "Gordon Jenkins"],
      ["Ballerina", "Vaughn Monroe"],
      ["Nature Boy", "King Cole with Frank De Vol"],
      ["Woody Woodpecker", "Kay Kyser with Gloria Wood"],
      ["Love Somebody", "Doris Day and Buddy Clark with George Siravo"],
      ["Now Is the Hour", "Gracie Fields with Phil Green"],
      ["Beg Your Pardon", "Francis Craig"],
      ["You Can't Be True, Dear", "Ken Griffin"],
      ["Toolie Oolie Doolie", "The Andrews Sisters with Vic Schoen"],
      ["Buttons and Bows", "Dinah Shore"],
      ["Golden Earrings", "Peggy Lee with Dave Barbour"],
      ["Baby Face", "Art Mooney"],
      ["Too Fat Polka", "Arthur Godfrey with Archie Bleyer"],
      ["Because", "Perry Como with Russ Case"],
      ...
      ["Woody Woodpecker", "The Sportsmen and Mel Blanc"],
      ["I'll Dance at Your Wedding", "Ray Noble and Buddy Clark"],
      ["The Dicky-Bird Song", "Freddy Martin"],
  ...
  [
      ...
      ["Slippin' Around", "Jimmy Wakely and Margaret Whiting"],
      ["I Can Dream, Can't I?", "The Andrews Sisters and Gordon Jenkins"],
      ["Cruising Down the River", "Russ Morgan Orchestra"],
      ...
      ["Again", "Gordon Jenkins Orchestra"],
      ["Forever and Ever", "Russ Morgan"],
      ["Forever and Ever", "Perry Como with Mitchell Ayres"],
      ["Don't Cry, Joe", "Gordon Jenkins Orchestra"],
      ["Room Full of Roses", "Sammy Kaye"],
      ["Far Away Places", "Bing Crosby and Ken Darby Choir"],
      ["Buttons and Bows", "Dinah Shore"],
      ...
      ["Whispering Hope", "Jo Stafford and Gordon MacRae with Paul Weston"],
      ["Maybe It's Because", "Dick Haymes"],
      ["Careless Hands", "Sammy Kaye Orchestra"],
      ["'A' You're Adorable", "Perry Como and The Fontane Sisters"],
      ["The Hucklebuck", "Tommy Dorsey Orchestra and Charlie Shavers"],
      ["I Don't See Me in Your Eyes Anymore", "Gordon Jenkins Orchestra and the Stardusters" ]
  ],
  [
      ["Too Young", "Nat King Cole with Les Baxter"],
      ["Because of You", "Tony Bennett with Percy Faith"],
      ["How High the Moon", "Les Paul and Mary Ford"],
      ["Come On-a My House", "Rosemary Clooney"],
      ["Be My Love", "Mario Lanza with Ray Sinatra and Jeff Alexander"],
      ["On Top of Old Smoky", "The Weavers and Terry Gilkyson with Vic Schoen"],
      ["Cold, Cold Heart", "Tony Bennett with Percy Faith"],
      ["If", "Perry Como with Mitchell Ayres"],
      ["The Loveliest Night of the Year", "Mario Lanza"],
      ["Tennessee Waltz", "Patti Page"],
      ["Jezebel", "Frankie Laine with Norman Luboff and Mitch Miller"],
      ["I Get Ideas", "Tony Martin with Henri René"],
      ...
      ["Sweet Violets", "Dinah Shore with Henri René"],
      ...
      ["Aba Daba Honeymoon", "Debbie Reynolds & Carleton Carpenter with Georgie Stoll"],
      ["Rose, Rose, I Love You", "Frankie Laine and Norman Luboff with Paul Weston"],
      ["Down Yonder", "Del Wood"],
      ["I Apologize", "Billy Eckstine"],
      ["Would I Love You (Love You, Love You)", "Patti Page"],
      ["You're Just in Love", "Perry Como & The Fontane Sisters with Mitchell Ayres"],
      ["Undecided", "Ames Brothers with The Les Brown Orchestra"],
      ["The Thing", "Phil Harris with Walter Scharf"],
  ...
  [
      ...
      ["You Belong to Me", "Jo Stafford with Paul Weston"],
      ["Auf Wiederseh'n, Sweetheart", "Vera Lynn with Her Majesty's Forces and Roland Shaw"],
      ["Half as Much", "Rosemary Clooney with Percy Faith"],
      ["Wish You Were Here", "Eddie Fisher with Hugo Winterhalter"],
      ["I Went to Your Wedding", "Patti Page"],
      ["Here in My Heart", "Al Martino"],
      ["Delicado", "Percy Faith with Stan Freeman"],
      ["Kiss of Fire", "Georgia Gibbs with Glenn Osser"],
      ["Anytime", "Eddie Fisher with Hugo Winterhalter"],
      ["Tell Me Why", "The Four Aces featuring Al Alberts"],
      ["The Blacksmith Blues", "Ella Mae Morse with Nelson Riddle"],
      ["Jambalaya (On the Bayou)", "Jo Stafford with Paul Weston and Norman Luboff"],
      ["Botch-a-Me (Ba-Ba-Baciami Piccina)", "Rosemary Clooney"],
      ["A Guy Is a Guy", "Doris Day with Paul Weston"],
      ["The Little White Cloud That Cried", "Johnnie Ray & The Four Lads"],
      ["High Noon", "Frankie Laine"],
      ["I'm Yours", "Eddie Fisher with Hugo Winterhalter"],
      ["The Glow-Worm", "The Mills Brothers and Hal McIntyre"],
      ["It's in the Book", "Johnny Standley with Horace Heidt"],
      ["Slow Poke", "Pee Wee King with Redd Stewart"],
      ["Walkin' My Baby Back Home", "Johnnie Ray with Buddy Cole"],
      ["Meet Mister Callaghan", "Les Paul"],
      ["I'm Yours", "Don Cornell with Norman Leyden"],
      ["Tell Me Why", "Eddie Fisher with Hugo Winterhalter"],
      ["Trying", "The Hilltoppers"],
      ["Please, Mr. Sun", "Johnnie Ray & The Four Lads" ]
  ],
  [
      ["The Song from Moulin Rouge", "Percy Faith featuring Felicia Sanders"],
      ["Vaya con Dios", "Les Paul and Mary Ford"],
      ["(How Much Is) That Doggie in the Window?", "Patti Page"],
      ["I'm Walking Behind You", "Eddie Fisher with Hugo Winterhalter"],
      ["You, You, You", "Ames Brothers with Hugo Winterhalter"],
      ["Till I Waltz Again with You", "Teresa Brewer with Jack Pleis"],
      ["April in Portugal", "Les Baxter"],
      ["No Other Love", "Perry Como with Henri René"],
      ["Don't Let the Stars Get in Your Eyes", "Perry Como"],
      ["I Believe", "Frankie Laine with Paul Weston"],
      ["Oh", "Pee Wee Hunt"],
      ["Ebb Tide", "Frank Chacksfield"],
      ["Pretend", "Nat King Cole with Nelson Riddle"],
      ["Ruby", "Richard Hayman"],
      ...
      ["Rags to Riches", "Tony Bennett with Percy Faith"],
      ["Anna", "Silvana Mangano"],
      ["Say You're Mine Again", "Perry Como"],
      ["Dragnet", "Ray Anthony"],
      ["Tell Me a Story", "Jimmy Boyd & Frankie Laine"],
      ["Crying in the Chapel", "June Valli"],
      ["Why Don't You Believe Me?", "Joni James with Lew Douglas"],
      ["Limelight (Terry's Theme)", "Frank Chacksfield"],
      ["With These Hands", "Eddie Fisher with Hugo Winterhalter"],
      ["C'est si bon", "Eartha Kitt with Henri René"],
      ["Have You Heard?", "Joni James with the Jack Halloran Choir and Lew Douglas" ]
  ],
  [
      ["Little Things Mean a Lot", "Kitty Kallen with Jack Pleis"],
      ["Wanted", "Perry Como with Hugo Winterhalter"],
      ["Hey There", "Rosemary Clooney with Buddy Cole"],
      ["Sh-Boom", "The Crew-Cuts with David Carroll"],
      ["Make Love to Me", "Jo Stafford with Paul Weston"],
      ["Oh! My Pa-Pa", "Eddie Fisher with Hugo Winterhalter"],
      ["(Oh Baby Mine) I Get So Lonely", "The Four Knights"],
      ["Three Coins in the Fountain", "The Four Aces featuring Al Alberts and Jack Pleis"],
      ["Secret Love", "Doris Day with Ray Heindorf"],
      ["Hernando's Hideaway", "Archie Bleyer"],
      ["Young at Heart", "Frank Sinatra"],
      ["This Ole House", "Rosemary Clooney with Buddy Cole"],
      ["I Need You Now", "Eddie Fisher with Hugo Winterhalter"],
  ...
  [
      ...
      ["Wild Night", "John Mellencamp with Meshell Ndegeocello"],
  ...
  [
      ...
      ["How Do U Want It / California Love", "2Pac featuring K-Ci and JoJo / featuring Dr. Dre and Roger Troutman"],
  ...
  [
      ...
      ["Back That Thang Up", "Juvenile featuring Mannie Fresh and Lil Wayne"],
  ...
  [
      ...
      [
          "Where Are Ü Now",
          "Skrillex and Diplo (Jack Ü) featuring Justin Bieber"
      ],
      [
          "Fight Song",
          "Rachel Platten"
  ...
  [
      ...
      [
          "Pop Style",
          "Drake featuring Jay-Z and Kanye West[a]"
      ],
      [
          "When We Were Young",
          "Adele"
      ...
      [
          "All the Way Up",
          "Fat Joe and Remy Ma featuring French Montana and Infared"
      ],
      [
          "Watch Me",
          "Silentó"
  ...
  [
      ...
      [
          "My Ex's Best Friend",
          "Machine Gun Kelly featuring Blackbear"
      ],
      [
          "Industry Baby",
  ...
  [
      ...
      [
          "Pushin P",
          "Gunna and Future featuring Young Thug"
      ],
      [
          "Buy Dirt",
      ...
      [
          "She Likes It",
          "Russell Dickerson featuring Jake Scott"
      ],
      [
          "Never Say Never",
  ...
  [
      ...
      [
          "Barbie World",
          "Nicki Minaj and Ice Spice with Aqua"
      ],
      [
          "Next Thing You Know",
          "Jordan Davis"
